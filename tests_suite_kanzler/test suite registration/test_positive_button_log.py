...
def test_two():
  ...
  root13 = web.find_element_by_xpath("//gx-button[@class='index-module__button_text--bold___2p9pg hydrated']") #Кнопка "Войти"
  shadow_root13 = expand_shadow_element(root13)
  ...
  string13 = web.find_element_by_xpath("//gx-button[@type='button']")
  string13.click()
  time.sleep(15)
  x = web.find_element_by_xpath("//div[@class='index-module__modal__title___3-14h']")
  find_element = x.text
  assert 'Войти' == find_element
  web.quit()
