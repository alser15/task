...
def test_nine():
  ...
  time.sleep(15)
  # Ищем надпись
  x = web.find_element_by_xpath("//gx-input[@name='last_name']/div[@slot='help-text']")
  ...
  assert 'Слишком длинная фамилия!' == find_text, 'Поле не найдено!' # 'Поле не найдено!' срабатывает, если в find_text пусто
  web.quit()
