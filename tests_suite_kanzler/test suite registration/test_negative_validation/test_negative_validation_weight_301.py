...
def test_twenty_eaght():
  ...
  er = web.find_element_by_xpath("//gx-input[@name='weight']/div[@slot='help-text']")
  ...
  assert 'Убедитесь, что это значение меньше либо равно 300.' == find_text, 'Поле не найдено!' # 'Поле не найдено!' срабатывает, если в find_text пусто
  web.quit() 
