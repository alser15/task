...
def test_one():
  ...
  er = web.find_element_by_xpath("//gx-input[@name='birthday']/div[@slot='help-text']")
  ...
  assert 'Допустимые возраст от 18 до 120 лет.' == find_text, 'Поле не найдено!' # 'Поле не найдено!' срабатывает, если в find_text пусто
  web.quit() 
