...
def test_twenty():
  ...
  er = web.find_element_by_xpath("//gx-input[@name='password']/div[@slot='help-text']")
  ...
  assert 'Сликом короткий пароль' == find_text, 'Поле не найдено!' # 'Поле не найдено!' срабатывает, если в find_text пусто
  web.quit() 
