...
def test_twenty_seven():
  ...
  assert 'Убедитесь, что это значение больше либо равно 40.' == find_text, 'Поле не найдено!' # 'Поле не найдено!' срабатывает, если в find_text пусто
  web.quit() 
