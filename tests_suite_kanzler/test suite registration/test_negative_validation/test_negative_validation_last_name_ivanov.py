...
def test_ten():
  ...
  time.sleep(5)
  # Ищем надпись
  x = web.find_element_by_xpath("//gx-input[@name='first_name']/div[@slot='help-text']")
  ...
  assert 'Специальные символы недопустимы.' == find_text, 'Поле не найдено!' # 'Поле не найдено!' срабатывает, если в find_text пусто
  web.quit()
