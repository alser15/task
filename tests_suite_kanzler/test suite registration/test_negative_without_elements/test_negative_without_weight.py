...
def test_eleven():
  ...
  #Скрол до кнопки "Регистрация"
  web.execute_script("return arguments[0].scrollIntoView(true);", string12)
  time.sleep(3)
  string12.click()
  time.sleep(3)
  ...
  assert 'Некорректный вес!' == find_text, 'Поле не найдено!' # 'Поле не найдено!' срабатывает, если в find_text пусто
  web.quit()
